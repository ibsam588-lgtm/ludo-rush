...
final class Dialogs {
    ...
    static void confirm(Activity activity, String emoji, String title, String message,
        ...
        msg.setTypeface(Typeface.create("sans-serif", Typeface.NORMAL));
        msg.setIncludeFontPadding(false);
        ...
        confirm.setTypeface(Typeface.create("sans-serif-medium", Typeface.BOLD));
