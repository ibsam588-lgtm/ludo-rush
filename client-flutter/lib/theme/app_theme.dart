...
class AppColors {
  ...
  static const List<Color> seatSoftColors = [
    Color(0xFFFF6F60), Color(0xFF42A5F5), Color(0xFFFFCA28), Color(0xFF66BB6A),
  ];

  static Color seatColor(int seat) => seatColors[seat.clamp(0, 3)];
  static Color seatColorSoft(int seat) => seatSoftColors[seat.clamp(0, 3)];
}
